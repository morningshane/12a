...
def main():
    ...
    for todo_item in todo_items:
        iw.text(333, t_y, unicode(todo_item['content']), 'robotoRegular18', 'black')
        t_y = (t_y + 24)
    ...
    for cal_item in cal_items:
        ...
        iw.text((dt_x + 7), (c_y + 5), iw.truncate(unicode(cal_item['content']), 'robotoRegular18'), 'robotoRegular18', 'black')
        c_y = (c_y + 32)
