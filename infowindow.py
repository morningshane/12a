...
def main():
    ...
    for todo_item in todo_items:
        iw.text(333, t_y, str(todo_item['content']), 'robotoRegular18', 'black', "utf-8")
        t_y = (t_y + 24)
    ...
    for cal_item in cal_items:
        (x, y) = iw.text(3, c_y, str(cal_item['date']), 'robotoRegular14', 'black', "utf-8")
        iw.line((dt_x + 5), c_y, (dt_x + 5), (c_y +32), 'black')
        iw.text(3, (c_y + 15), str(cal_item['time']), 'robotoRegular14', 'black')
        iw.text((dt_x + 7), (c_y + 5), iw.truncate(str(cal_item['content']), 'robotoRegular18', "utf-8"), 'robotoRegular18', 'black')
        c_y = (c_y + 32)
